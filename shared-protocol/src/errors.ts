export const PROTOCOL_ERROR = {
    ...
    SOCIAL_REQUEST_DUPLICATE: 'SOCIAL_REQUEST_DUPLICATE',

    // Preferences
    PREFERENCES_INVALID_PATCH: 'PREFERENCES_INVALID_PATCH',

    // Ranking
    RANKING_QUEUE_NOT_FOUND: 'RANKING_QUEUE_NOT_FOUND',
    RANKING_SEASON_NOT_FOUND: 'RANKING_SEASON_NOT_FOUND',
